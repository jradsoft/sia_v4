...
<xsl:template match="//cfdi:Comprobante">
   ...
   <body background="fondo.jpg">
                           ...
                           <font color="#000000" face="Courier New" size="3">
                             <b>
                               ...
                               <xsl:for-each select="./cfdi:Impuestos/cfdi:Retenciones/cfdi:Retencion">
                                 ...
                                 <xsl:if test="@Impuesto = '003' and (@Importe > 0) ">
                                   <tr>
                                     <td align="right">
                                       <font color="#000000" face="Courier New" size="3">
                                         <b>
                                           <xsl:value-of select="@Impuesto"/>-RET IEPS
                                         </b>
                                       </font>
                                     </td>
     ...
     <xsl:variable name="uuid" select="//cfdi:Complemento/tfd:TimbreFiscalDigital/@UUID"/>
     <xsl:variable name="emisor"   select="//cfdi:Comprobante/cfdi:Emisor/@Rfc"/>
             <xsl:variable name="receptor" select="//cfdi:Comprobante/cfdi:Receptor/@Rfc"/>
             <xsl:variable name="total" select="format-number(//cfdi:Comprobante/@Total,'#############.######')"/>
             <xsl:variable name="sellocfd" select="substring(//cfdi:Complemento/tfd:TimbreFiscalDigital/@SelloCFD, 337)"/>
             <img src="https://api.qrserver.com/v1/create-qr-code/?size=300x300&amp;data=https://sat.mx/detallecfdi.aspx?&amp;Id={$uuid};&amp;Re={$emisor};&amp;Rr={$receptor};&amp;Tt={$total};&amp;Fe={$sellocfd}"/>
